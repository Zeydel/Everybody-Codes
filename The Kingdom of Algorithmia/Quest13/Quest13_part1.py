...
def parse(notes):
    ...
    return (nodes, start_pos, end_pos)
...
# Parse the input
nodes, start_pos, end_pos = parse(lines)

# Get all shortest time
shortest_times = get_shortest_times(nodes, start_pos)

# Print the results
print(f"{shortest_times[end_pos]} seconds is the shortest time to get to the exit")